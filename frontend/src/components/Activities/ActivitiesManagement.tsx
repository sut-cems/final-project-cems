        ...
        <div className="relative container mx-auto px-4 py-6">
          ...
          <div className="hidden md:flex justify-between items-center">
            ...
            <button
              ...
              className="group relative bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/30 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer"
            >
          ...
          <div className="md:hidden space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-xl font-bold bg-gradient-to-r from-white to-yellow-200 bg-clip-text text-transparent">
                  กิจกรรมของชมรม
                </h1>
            ...
            <div className="flex justify-center">
              <button
                onClick={() => navigate("/activities/create")}
                className="group relative bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/30 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer w-full sm:w-auto"
              >
